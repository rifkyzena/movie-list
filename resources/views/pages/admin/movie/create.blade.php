    ...
    <div class="container py-5">
        ...
        <form class="col-12" method="" id="login">
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-dark border-0" id="title">
            </div>
            <div class="mb-3">
                <label for="desc" class="col-2 col-form-label">Description</label>
                <textarea class="form-control bg-dark border-0" rows="7" id="desc"></textarea>
            </div>
            <div class="mb-3">
                <label for="title" class="col-2 col-form-label">Genre</label>
                <select class="form-select bg-dark border-0" placeholder="Select genre">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control bg-dark border-0" id="directors">
            </div>
            <div class="mb-3">
                <label for="release" class="col-2 col-form-label">Release Date</label>
                <input type="date" class="form-control bg-dark border-0" id="release">
            </div>
            <div class="mb-3">
